    ...
    <table>
        ...
        <tbody>
            <?php if ($result->num_rows === 0): ?>
                <tr><td colspan="9" style="text-align:center; padding:20px;">No tasks yet.</td></tr>
            <?php else: ?>
                            ...
                            <td colspan="9" style="padding-left:40px; background:#f0eaff;">
                                ...
                                <ul>
                                    <?php while($subtask=$subtask_result->fetch_assoc()):
                                        ...
                                        <li>
                                            <input type="checkbox" class="subtask-toggle" data-subtask-id="<?php echo $subtask['id']; ?>" <?php echo $checked; ?>>
